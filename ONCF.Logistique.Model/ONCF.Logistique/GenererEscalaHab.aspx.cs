...
namespace ONCF.Logistique
{
    public partial class GenererEscalaHab : System.Web.UI.Page
    {
        ...
        {
            DataSet ds_GetEscala = BLLLivraison.SGPL_GetListP_Escala("970031Z01 &FEUILLE DE CHARGEMENT");
        ...
        protected void BTN_Enregistrer_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              {
                MAJESCALAModif(((Label)GDVArticle.Rows[0].FindControl("ArticleId")).Text, Convert.ToInt32(((Label)GDVArticle.Rows[0].FindControl("Lbl_Ordre")).Text));
