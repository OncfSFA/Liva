...
CodeBehind="ReceptionCommandeImp.aspx.cs" Inherits="ReceptionCommandeImp" %>
   ...
   <div align="left">
    ...
    <asp:GridView ID="GDVArticle" runat="server" AutoGenerateColumns="False" 
               Width="100%"   AllowPaging ="false"
                                        BorderStyle="None"   EmptyDataText="Aucune Données n'existe">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr width="100%" align="center">
                                                            <td width="16%">
                                                             <asp:Label ID="LblIdMagasinReception" runat="server" Visible="false" Text='<%# Eval("MagasinReception_MagasinId") %>' ></asp:Label>
