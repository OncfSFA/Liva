<%@ Page Title="" Language="C#" MasterPageFile="~/MasterONCF.master" AutoEventWireup="true" CodeBehind="ValidationPolOLD.aspx.cs" Inherits="ONCF.Logistique.ValidationPolOLD" %>
        ...
        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" 
            Enabled="True" PopupPosition="right" TargetControlID="CompareValidator1">
                    ...
                    <tr id="lblag" runat="server"  Visible="false">
                       ...
                       <td id="tdEtab" width="50%" style="height: 37px">
                                <p>
        ...
        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" 
            Enabled="True" PopupPosition="right" TargetControlID="CompareValidator1">
                       ...
                       <td width="50%" style="height: 37px">
                                ...
                                <asp:Button ID="BTN_Rejet" runat="server" Text="Rejet" class="bts" 
                                     Visible="False" onclick="BTN_Rejet_Click" />
