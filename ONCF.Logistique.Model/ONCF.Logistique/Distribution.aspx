<%@ Page Title="" Language="C#" MasterPageFile="~/MasterONCF.master" AutoEventWireup="true"
    CodeBehind="Distribution.aspx.cs" Inherits="ONCF.Logistique.Distribution" %>
                    ...
                    <div class="left-form">
                        <table id="Table1" width="100%" runat="server">
                            <tr id="TableZom" runat="server">
                                <td>
                                    <p>
                                        ...
                                        <asp:DropDownList ID="DDL_Article" runat="server" Height="16px" Width="142px" OnSelectedIndexChanged="DDL_Article_SelectedIndexChanged"
                                            ...
                                            DataValueField="ArticlePrevision_ArticleDesing" AppendDataBoundItems="true" >
                                ...
                                <td>
                                    <asp:Button ID="BtnModif" class="bts" runat="server" Text="Enregistrer" ValidationGroup="v"
                                        Visible="false" onclick="BtnModif_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GDVArticle_Modif" runat="server" AutoGenerateColumns="False" Width="100%"
                                        AllowPaging="false" BorderStyle="None" 
                                        EmptyDataText="Pas de données pour cette article">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr width="100%" align="center" height="35px">
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="lbl_qte_D_"
                                                                ...
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ClientIDMode="AutoID"
                                                                    ControlToValidate="lbl_qte_D_" Display="None" ErrorMessage="&lt;b&gt;seul les valeurs numériques autorisées&lt;/b&gt;"
                                                                ...
                                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="lbl_qte_D_"
