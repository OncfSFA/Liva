...
{
    public partial class ConsultationPolHab : System.Web.UI.Page
    {
        ...
        protected void DDLDirection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataSet dsPrevision = BLLPrevision.GetPrevisionForValidHabil(DDLDirection.SelectedValue, Convert.ToInt32(Session["Modele"].ToString()), "Dir", Convert.ToInt32(DDLStatut.SelectedValue));
        ...
        {
            DataSet dsPrevision = BLLPrevision.GetPrevisionForValidHabil(DDLEtablissementMere.SelectedValue, Convert.ToInt32(Session["Modele"].ToString()), "Mere", Convert.ToInt32(DDLStatut.SelectedValue));
        ...
        protected void DDLStatut_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DDLEtablissementMere.SelectedValue = "0";
