...
public partial class CreationLotImp : System.Web.UI.Page
{
    ...
    protected void BtnEnregistrer_Click(object sender, EventArgs e)
    {
        ...
        {
            // TODO : N° OL a généré automatique avec client
    ...
    public void GetPDF(int _ID)
    {
        ...
        Response.Redirect(cheminReports + "Ordre de livraison des imprimes&rs:Command=Render&rs:ClearSession=true&OrdreLivraison_Id=" + _ID + "&OrderNum=" + TxtLot.Text + "&Marche=" + Txt_Marcher.Text);
