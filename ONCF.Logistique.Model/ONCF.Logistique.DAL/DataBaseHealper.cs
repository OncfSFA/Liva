...
namespace DAL
{
    public class DatabaseHelper : IDisposable
    {
        ...
        public DatabaseHelper(string connectionstring, Providers provider)
        {
            ...
            switch (provider)
            {
                ...
                case Providers.ConfigDefined:
                    string providername = ConfigurationManager.ConnectionStrings["CNX_Logistique"].ProviderName;
                    switch (providername)
                    {
        ...
        public DatabaseHelper(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["CNX_Logistique"].ConnectionString, provider)
        {
        }
        ...
        public DatabaseHelper()
            : this(ConfigurationManager.ConnectionStrings["CNX_Logistique"].ConnectionString, Providers.ConfigDefined)
        {
        }
        ...
        public DataSet ExecuteDataSet(string query, CommandType commandtype, ConnectionState connectionstate)
        {
            ...
            objCommand.CommandText = "SET DATEFORMAT DMY";
        ...
        public bool ConnexionStates(string connectionstring)
        {
            strConnectionString = connectionstring;
